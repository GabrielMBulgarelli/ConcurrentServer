...
void TcpServer::acceptConnectionRequest() {
  ...
  // Stop accept() and clean exit when signals (e.g. Ctrl+C) are sent
  ...
  // Handle the connection is a virtual
  // method that must be implemented by the derived class
  // this is a abstract server only
}
